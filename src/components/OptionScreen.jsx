...
const Header = () => {
  return (
    <div className="flex items-center mb-10 w-full justify-center">
      <img src="assets/icon.png" alt="TabyAI Icon" className="w-16 h-16" />
      <div className="flex flex-col">
        <h1 className="text-3xl font-semibold">TabyAI</h1>
      </div>
    </div>
  );
};
...
const About = () => {
  return (
    <div className="mb-5 p-4 bg-white rounded-lg shadow w-1/2 mx-auto max-w-[800px]">
      <h2 className="text-xl font-semibold">About TabyAI</h2>
      <hr className="my-4" />
...
const Options = () => {
  return (
    <div className="flex flex-col justify-center items-center bg-gray-100 font-sans p-8">
      <Header />
      <About />
      <Settings />
      <Footer />
